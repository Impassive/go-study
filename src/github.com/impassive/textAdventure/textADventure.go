...
func (node *storyNode) executeCmd(cmd string) *storyNode {
	...
	fmt.Println("Sorry, I didn't undestand that.")
	return node
}
...
func main() {
	...
	You are in large chamber, deep nderground.
	You see three passages leading out. A north passage leads into darkness.
	To be south, a passage appears to head upward. The easter passage appears
	flat and well traveled`}

	darkRoom := storyNode{text: "It's pitch black. You cannot see a thing."}
	darkRoomLit := storyNode{text: "The dark passage is now lit by your lantern. You can continude north or head back south."}

	grue := storyNode{text: "While stumbling around in the darkness, you are eaten by a grue."}

	trap := storyNode{text: "You head down the well traveled path when suddenly trap door opens and you fall into a pit."}
	...
	darkRoom.addChoice("S", "Try to get back south", &grue)
